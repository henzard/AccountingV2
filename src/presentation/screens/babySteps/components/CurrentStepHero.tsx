  ...
  if (stepNumber === 3) {
    return (
      <View style={styles.ctaContainer} testID="cta-no-income">
        <MaterialCommunityIcons name="cash-plus" size={40} color={outlineVariantColor} />
        <Text variant="bodyMedium" style={[styles.ctaText, { color: onSurfaceVariantColor }]}>
  ...
  if (stepNumber === 1) {
    return (
      <View style={styles.ctaContainer} testID="cta-no-emf">
        <MaterialCommunityIcons name="shield-alert-outline" size={40} color={outlineVariantColor} />
        <Text variant="bodyMedium" style={[styles.ctaText, { color: onSurfaceVariantColor }]}>
  ...
  if (stepNumber === 2 || stepNumber === 6) {
    return (
      <View style={styles.ctaContainer} testID="cta-no-debts">
        <MaterialCommunityIcons name="bank-outline" size={40} color={outlineVariantColor} />
        <Text variant="bodyMedium" style={[styles.ctaText, { color: onSurfaceVariantColor }]}>
      ...
      >
        <View style={styles.heroHeader}>
          ...
          <View style={styles.heroTitleBlock}>
            <Text
              variant="labelSmall"
              style={[styles.stepLabel, { color: colors.onPrimaryContainer }]}
            >
            ...
            <Text
              variant="bodySmall"
              style={[styles.heroDesc, { color: colors.onPrimaryContainer }]}
            >
              {rule.description}
            </Text>
          </View>
    ...
    >
      <View style={styles.heroHeader}>
        ...
        <View style={styles.heroTitleBlock}>
          ...
          <Text variant="bodySmall" style={[styles.heroDesc, { color: colors.onPrimaryContainer }]}>
            {rule.description}
          </Text>
        </View>
      </View>
      ...
      <Text
        variant="titleMedium"
        style={[styles.progressLabel, { color: colors.onPrimaryContainer }]}
      >
        {progressLabel}
      </Text>
    </Surface>
